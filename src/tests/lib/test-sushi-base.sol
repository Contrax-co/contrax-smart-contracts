...
contract DSTestSushiBase is DSTestDefiBase {
    ...
    UniswapRouterV2 sushiRouter =
        UniswapRouterV2(0xd9e1cE17f2641f24aE83637ab66a2cca9C378B9F);

    IUniswapV2Factory sushiFactory =
        IUniswapV2Factory(0xC0AEe478e3658e2610c5F7A4A2E1777cE9e4f2Ac);

    function _getERC20(address token, uint256 _amount) internal override {
