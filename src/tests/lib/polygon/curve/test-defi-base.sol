...
contract DSTestDefiBase is DSTestApprox {
    ...
    address three_pool = 0x445FE580eF8d70FF569aB36e80c647af338db351;
    address three_gauge = 0xe381C25de995d62b453aF8B931aAc84fcCaa7A62;
    address three_crv = 0xE7a24EF0C5e95Ffb0f6684b813A78F2a3AD7D171;
    ...
    UniswapRouterV2 univ2 =
        UniswapRouterV2(0xa5E0829CaCEd8fFDD4De3c43696c57F7D7A678ff);
    ...
    function _getERC20WithMatic(address token, uint256 _maticAmount)
        internal
        virtual
    {
