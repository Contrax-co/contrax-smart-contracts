...
contract ControllerV6 {
    ...
    function earn(
        ...
        IERC20(IUniswapV3Pool(_pool).token0()).safeTransfer(
            _strategy,
            _token0Amount
        );
        IERC20(IUniswapV3Pool(_pool).token1()).safeTransfer(
            _strategy,
            _token1Amount
        );
    ...
    function withdrawAll(address _pool)
        public
    ...
    function withdraw(address _pool, uint256 _amount)
        public
        returns (uint256 a0, uint256 a1)
    {
