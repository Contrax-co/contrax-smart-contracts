...
contract GammaController is SphereXProtected {
  ...
  function revokeStrategy(
    address _token,
    address _strategy
  ) public onlyGovernance sphereXGuardPublic(0xc5a2d3b1, 0x590bbb60) {
  ...
  function setStrategy(
    address _token,
    address _strategy
  ) public onlyGovernance sphereXGuardPublic(0x6c58ae0f, 0x72cb5d97) {
  ...
  function inCaseTokensGetStuck(
    address _token,
    uint256 _amount
  ) public onlyGovernance sphereXGuardPublic(0xd39eb81a, 0xc6d758cb) {
  ...
  function inCaseStrategyTokenGetStuck(
    address _strategy,
    address _token
  ) public onlyGovernance sphereXGuardPublic(0x940ae9e9, 0x197baa6d) {
