...
contract VaultZapEthFish is ZapperBase {
    ...
    function zapOutAndSwap(address vault_addr, uint256 withdrawAmount, address desiredToken, uint256 desiredTokenOutMin) public override sphereXGuardPublic(0x3d603ffa, 0xf3cc669a) {
       ...
       function zapOutAndSwapEth(address vault_addr, uint256 withdrawAmount, uint256 desiredTokenOutMin) public override sphereXGuardPublic(0xf63c3829, 0x02006da0) {
        (IVault vault, IUniswapV2Pair pair) = _getVaultPair(vault_addr);
        address token0 = pair.token0();
        address token1 = pair.token1();
    ...
    function _swapAndStake(address vault_addr, uint256 tokenAmountOutMin, address tokenIn) public override sphereXGuardPublic(0x15865bc5, 0xb384bcbc) {
