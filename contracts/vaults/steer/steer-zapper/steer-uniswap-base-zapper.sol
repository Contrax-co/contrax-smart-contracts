...
contract SteerZapperUniswapBase is PriceCalculatorV3 {
  ...
  function _swap(address tokenIn, address tokenOut, uint256 amountIn) private {
    ...
    ISwapRouter2.ExactInputSingleParams memory params = ISwapRouter2.ExactInputSingleParams({
      tokenIn: path[0],
      tokenOut: path[1],
    ...
    ISwapRouter2(address(router)).exactInputSingle(params);
  }
