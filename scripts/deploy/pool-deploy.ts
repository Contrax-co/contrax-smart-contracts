...
async function main() {
    ...
    const deploy = async (name) => {
        ...
        switch(pools[name].controller){
            case "sushi": controller_addr=""; break;
        }
